...
import {  EventCategoryDataType,  PostDataType, TaxonomyType } from "data/types";
...
export interface SectionSliderNewCategoriesProps {
  ...
  heading: string;
  subHeading: string;
  categories: EventCategoryDataType;
...
const SectionSliderNewCategories2: FC<SectionSliderNewCategoriesProps> = ({
  ...
  const renderCard = (item: EventCategoryDataType, index: number) => {
