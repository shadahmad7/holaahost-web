  ...
  return (
    ...
    >
      ...
      <div className="container py-16 lg:py-28 space-y-8 lg:space-y-8">
        ...
        <h2 className="text-2xl font-semibold">Privacy Policy for Holaahost</h2>
        <p>
          At Holaahost, accessible from www.holaahost.com, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Holaahost and how we use it. <br></br>
        ...
        <p>
          Holaahost follows a standard procedure of using log files. These files
        ...
        <p>
          Like any other website, Holaahost uses 'cookies'. These cookies are
        ...
        <p>
          ...
          <br></br>• Google https://policies.google.com/technologies/ads
        </p>
        <h2 className="text-2xl font-semibold">Privacy Policies</h2>
        <p>
          You may consult this list to find the Privacy Policy for each of the
          advertising partners of Holaahost.<br></br>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Holaahost, which are sent
          directly to users' browser. They automatically receive your IP address
          when this occurs. These technologies are used to measure the
          effectiveness of their advertising campaigns and/or to personalize the
          advertising content that you see on websites that you visit.<br></br>
          Note that Holaahost has no access to or control over these cookies
          that are used by third-party advertisers
        </p>
        <h2 className="text-2xl font-semibold">Third Party Privacy Policies</h2>
        <p>
          Holaahost's Privacy Policy does not apply to other advertisers or
          websites. Thus, we are advising you to consult the respective Privacy
          Policies of these third-party ad servers for more detailed
          information. It may include their practices and instructions about how
          to opt-out of certain options.<br></br>
        ...
        <p>
          ...
          shared and/or collect in Holaahost. This policy is not applicable to
